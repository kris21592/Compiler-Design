...
public class ScannerTest {
	...
	@Test public void t1() throws LexicalException {

		String str = "\"file file1  \\n \\t \" log log1 0abs";
		//show(str);
		Scanner scanner = new Scanner(str).scan();
		show(str);
		show(scanner);
	...
	@Test public void t2() throws LexicalException {
	...
	@Test public void t3() throws LexicalException {
	...
	@Test public void t4() throws LexicalException {
		String str = "\" \\n \\t\"";
		Scanner scanner = new Scanner(str).scan();
		show(str);
		show(scanner);
